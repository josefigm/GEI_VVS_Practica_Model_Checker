...
/*** From source: algoritmo2_mutual_exclusion.pml ***/
...
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "algoritmo2_mutual_exclusion.pml.nvr", 1, 10 },
	{ "-", 11, 12 }
};
short *src_claim;
uchar reached2 [] = {
...
short src_ln1 [] = {
	  0,  56,  16,  17,  15,  16,  17,  15, 
	 60,  25,  24,  25,  24,  55,  65,  55, 
	 65,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "algoritmo2_mutual_exclusion.pml", 1, 16 },
	{ "-", 17, 18 }
};
uchar reached1 [] = {
	  0,   1,   1,   0,   0,   1,   0,   0, 
...
short src_ln0 [] = {
	  0,  37,  16,  17,  15,  16,  17,  15, 
	 41,  25,  24,  25,  24,  36,  46,  36, 
	 46,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "algoritmo2_mutual_exclusion.pml", 1, 16 },
...
{	int j = 0, h = now._nr_pr;
	...
	case 1:	/* Q */
		...
		/* params: */
		/* locals: */
		((P1 *)pptr(h))->greater_fork = ( ((((int)((P1 *)_this)->_pid)>((((int)((P1 *)_this)->_pid)+1)%2))) ? (((int)((P1 *)_this)->_pid)) : (((((int)((P1 *)_this)->_pid)+1)%2)) );
		((P1 *)pptr(h))->minor_fork = ( ((((int)((P1 *)_this)->_pid)<((((int)((P1 *)_this)->_pid)+1)%2))) ? (((int)((P1 *)_this)->_pid)) : (((((int)((P1 *)_this)->_pid)+1)%2)) );
#ifdef VAR_RANGES
		logval("Q:greater_fork", ((P1 *)pptr(h))->greater_fork);
		logval("Q:minor_fork", ((P1 *)pptr(h))->minor_fork);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* P */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->greater_fork = ( ((((int)((P0 *)_this)->_pid)>((((int)((P0 *)_this)->_pid)+1)%2))) ? (((int)((P0 *)_this)->_pid)) : (((((int)((P0 *)_this)->_pid)+1)%2)) );
		((P0 *)pptr(h))->minor_fork = ( ((((int)((P0 *)_this)->_pid)<((((int)((P0 *)_this)->_pid)+1)%2))) ? (((int)((P0 *)_this)->_pid)) : (((((int)((P0 *)_this)->_pid)+1)%2)) );
#ifdef VAR_RANGES
		logval("P:greater_fork", ((P0 *)pptr(h))->greater_fork);
		logval("P:minor_fork", ((P0 *)pptr(h))->minor_fork);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("onTable[l_in]", now.onTable[l_in]);
		}
	}
#endif
}
...
{	/* int i; */
	...
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	bit    onTable[%d]:	%d\n", l_in, now.onTable[l_in]);
		}
	}
}
void
...
{	/* int i; */
	...
	printf("	int    greater_fork:	%d\n", ((P1 *)pptr(pid))->greater_fork);
	printf("	int    minor_fork:	%d\n", ((P1 *)pptr(pid))->minor_fork);
		break;
	case 0:
		printf("local vars proc %d (P):\n", pid);
	printf("	int    greater_fork:	%d\n", ((P0 *)pptr(pid))->greater_fork);
	printf("	int    minor_fork:	%d\n", ((P0 *)pptr(pid))->minor_fork);
		break;
	}
}
void
