...
#define PanSource	"algoritmo2_mutual_exclusion.pml"
...
#define Air1	(sizeof(P1) - Offsetof(P1, minor_fork) - 1*sizeof(int))
...
#define Air0	(sizeof(P0) - Offsetof(P0, minor_fork) - 1*sizeof(int))
